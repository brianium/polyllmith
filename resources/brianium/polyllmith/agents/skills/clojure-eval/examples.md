...
```bash
clj-nrepl-eval -p 7888 "(require '[{{top/ns}}.{{main/ns}}.example :as example] :reload)"
```

Then call functions from it:

```bash
clj-nrepl-eval -p 7888 "(example/some-function arg1 arg2)"
```
...
```bash
clj-nrepl-eval -p 7888 "(require '[{{top/ns}}.{{main/ns}}.example] :reload)"
```
...
clj-nrepl-eval -p 7888 "(require '[{{top/ns}}.{{main/ns}}.example-test] :reload)"
clj-nrepl-eval -p 7888 "(run-tests '{{top/ns}}.{{main/ns}}.example-test)"
```
