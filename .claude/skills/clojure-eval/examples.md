...
```bash
clj-nrepl-eval -p 7888 "(require '[polyllmith.example :as example] :reload)"
```
...
```bash
clj-nrepl-eval -p 7888 "(require '[polyllmith.example] :reload)"
```
...
clj-nrepl-eval -p 7888 "(require '[polyllmith.example-test] :reload)"
clj-nrepl-eval -p 7888 "(run-tests 'polyllmith.example-test)"
```
